...
import { Hash, Users, ArrowRightLeft, Activity, Cpu, HardDrive, Clock, Layers } from "lucide-react";
...
export default function OnchainPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">온체인 분석</h1>
      ...
      {/* Network */}
      <section>
        <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">네트워크 지표</h2>
      ...
      {/* Wallets */}
      <section>
        <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">지갑 분석</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <MetricCard
            title="활성 주소 (24h)"
      ...
      {/* Transactions */}
      <section>
        <h2 className="text-lg font-semibold text-[var(--color-text-primary)] mb-4">트랜잭션 분석</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <MetricCard
            title="일일 트랜잭션"
      ...
      {/* Info card */}
      <Card className="p-6">
        <h3 className="font-semibold text-[var(--color-text-primary)] mb-2">데이터 출처</h3>
